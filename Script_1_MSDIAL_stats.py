...
As output, this script exports a clean excel file with relevant statistics:
 - Using TIC sum normalization, generate t test p-values to describe which metabolites are significantly present in CC and not MC (p_val_CC_vs_MC), and which metabolites are significantly present in AR and not MC (p_val_AR_vs_MC).
